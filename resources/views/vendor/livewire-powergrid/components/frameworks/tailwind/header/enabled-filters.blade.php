        ...
        @if (count($enabledFilters) > 1)
            <div class="flex group items-center gap-3 cursor-pointer">
                <span
                    ...
                    class="bg-gray-800 px-4 py-2 text-white select-none rounded-sm outline-none inline-flex items-center border px-2 py-0.5 font-bold text-xs border-pg-primary-500 dark:border-pg-primary-600"
                >
            ...
            @isset($filter['label'])
                ...
                >
                    <span
                        ...
                        class="bg-gray-800 px-4 py-2 text-white select-none rounded-sm outline-none inline-flex items-center border px-2 py-0.5 font-bold text-xs border-pg-primary-300 dark:border-pg-primary-600"
                    >
                        {{ $filter['label'] }}
                        <x-livewire-powergrid::icons.x class="w-4 h-4 ml-1" />
                    </span>
