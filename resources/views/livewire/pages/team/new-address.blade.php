...
new class extends Component {
    ...
    public function insert()
    {
        ...
        $captainAddress = new CaptainAddress();
        $captainAddress->captain_id = $this->captainId;
        $captainAddress->company_name = $validatedData['company_name'];
        $captainAddress->address = $validatedData['address'];
        $captainAddress->city = $validatedData['city'];
        $captainAddress->postal_code = $validatedData['postal_code'];
        $captainAddress->phone_number = $validatedData['phone_number'];
        $captainAddress->pin = $validatedData['pin'];
        $captainAddress->jbkjs = $validatedData['jbkjs'];
        $captainAddress->identification_number = $validatedData['identification_number'];
        $captainAddress->save();
