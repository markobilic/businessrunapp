...
@section('content')
<h2 style="text-align: center;">Devis</h2>
<table style="width: 100%;">
    <tr>
        ...
        <td style="width: 50%; text-align: right;">
            ...
            <p><strong>Date limite de paiement: </strong>{{$invoice['paymentEndDate']}}</p>
...
<table style="width: 100%;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="width: 22,5%;height: 40px;text-align: right">Total</td>
        ...
        <tr style=" background-color: lightgray">
            <td style="width: 50%;height: 40px;text-align: left"></td>
            <td style="width: 5%;height: 40px;text-align: center"></td>
            <td style="width: 22,5%;height: 40px;text-align: right"><strong>Total Prix</strong></td>
