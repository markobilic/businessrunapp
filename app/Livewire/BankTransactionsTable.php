...
final class BankTransactionsTable extends PowerGridComponent
{
    use WithExport;
    ...
    public string $tableName = 'bankTransactionsTable';
    ...
    public function setUp(): array
    {
        ...
        return [
            PowerGrid::exportable(fileName: 'bank-transactions-export-file')
    ...
    public function datasource(): Collection
    {
        ...
        $transactions = $transactions->map(function ($transaction) {
            if ($transaction->reservation) 
            {
                ...
                $transaction->debt = $this->calculateTotalEstimate($reservation) - $reservation->bankTransactions->sum('potrazuje_copy');
            } 
            else 
            {
    ...
    public function columns(): array
    {
        return [
            ...
            Column::add()
                ...
                ->searchable(),   
            Column::add()
                ->title(__('Vas broj naloga'))
                ->field('vas_broj_naloga')
                ->sortable()
                ->searchable(),                     
            Column::add()
                ->title(__('Broj racuna primaoca posiljaoca'))
                ->field('broj_racuna_primaoca_posiljaoca')
                ->sortable()
                ->searchable(),  
            Column::add()
                ->title(__('Opis'))
                ...
                ->searchable(),  
            Column::add()
                ->title(__('Sifra placanja'))
                ->field('sifra_placanja')
                ->sortable()
                ->searchable(),  
            Column::add()
                ->title(__('Sifra placanja opis'))
                ->field('sifra_placanja_opis')
                ->sortable()
                ->searchable(),  
            Column::add()
                ->title(__('Duguje'))
            ...
            Column::add()
                ...
                ->searchable(),     
            Column::add()
                ->title(__('Model zaduzenja odobrenja'))
                ->field('model_zaduzenja_odobrenja')
                ->sortable()
                ->searchable(),  
            Column::add()
                ->title(__('Poziv na broj zaduzenja odobrenja'))
                ->field('poziv_na_broj_zaduzenja_odobrenja')
                ->sortable()
                ->searchable(),  
            Column::add()
                ->title(__('Model korisnika'))
                ->field('model_korisnika')
                ->sortable()
                ->searchable(),  
            Column::add()
                ...
                ->searchable(),  
            Column::add()
                ->title(__('Broj za reklamaciju'))
                ->field('broj_za_reklamaciju')
                ->sortable()
                ->searchable(),  
            Column::add()
                ->title(__('referenca'))
                ...
                ->searchable(),  
            Column::add()
                ->title(__('Objasnjenje'))
                ->field('objasnjenje')
                ->sortable()
                ->searchable(),  
            Column::add()
                ->title(__('Datum valute'))
                ->field('datum_valute_formatted', 'datum_valute')
                ->sortable()
                ->searchable(),                
            Column::add()
                ->title(__('Broj izvoda'))
                ->field('broj_izvoda')
                ->sortable()
                ->searchable(),                
            Column::add()
    ...
    public function onUpdatedToggleable($id, $field, $value): void
    {
        ...
        {           
            ...
            if ($transactionCheck) 
            {
                $paidDate = $transactionCheck->datum_izvoda;
            }
            else
            {
                $paidDate = null;
            ...
            if($value === "1")
            {
                ...
                if($bankTransaction->potrazuje_copy > 0)
                {
                    if($bankTransaction->datum_izvoda > $reservation->race->starting_date)
                    {
